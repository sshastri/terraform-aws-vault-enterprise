...
variable "consul_tls_ca" {
  description = "The name of the Consul TLS CA chain in the S3 bucket install_files."
  type        = "string"
  default     = "ca.pem"
}

variable "consul_tls_cert" {
  description = "The name of the Consul TLS cert in the S3 bucket install_files."
  type        = "string"
  default     = "consul.pem"
}

variable "consul_tls_key" {
  description = "The name of the Consul TLS key in the S3 bucket install_files."
  type        = "string"
  default     = "consul.key"
}

variable "vault_tls_cert" {
  description = "The name of the Vault TLS cert in the S3 bucket install_files."
  type        = "string"
  default     = "vault.pem"
}

variable "vault_tls_key" {
  description = "The name of the Vault TLS key in the S3 bucket install_files."
  type        = "string"
  default     = "vault.key"
}
...
/* Other values for things */

variable "elb_fqdn" {
  description = "A CNAME record pointing to the Vault ELB DNS name"
  type        = "string"
  default     = ""
}
